...
class Product1Screen extends ConsumerStatefulWidget {
  const Product1Screen({super.key});

  @override
  ConsumerState<Product1Screen> createState() => _Product1ScreenState();
}

class _Product1ScreenState extends ConsumerState<Product1Screen> {
  int _quantity = 2;
  double _spiceLevel = 0.4;
            ...
            children: [
              ...
              Center(
                child: Image.asset(
                  ...
                  width: SizeConfig.w(350), height: SizeConfig.w(355), fit: BoxFit.contain,
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: AppTextStyles.robotoSemiBold.copyWith(fontSize: SizeConfig.w(24)),
                ),
              ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text('4.9', style: AppTextStyles.robotoMedium.copyWith(fontSize: SizeConfig.w(14))),
                    SizedBox(width: SizeConfig.w(18)),
                    Container(width: SizeConfig.w(8), height: 1, color: AppColors.textPrimary),
                    SizedBox(width: SizeConfig.w(10)),
                    Text('26 mins', style: AppTextStyles.robotoRegular.copyWith(fontSize: SizeConfig.w(14), color: AppColors.textSecondary)),
                  ],
                ),
              ),
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ref.read(cartProvider.notifier).addItem(
                            CartItem(productId: '1', name: "Cheeseburger Wendy's Burger", price: '\$8.24', quantity: _quantity),
                          );
                        ...
                        child: Container(
                          ...
                          child: Text(
                            'ORDER NOW',
                            style: AppTextStyles.robotoSemiBold.copyWith(fontSize: SizeConfig.w(18), color: AppColors.white),
                          ),
                        ),
                      ),
                    ),
