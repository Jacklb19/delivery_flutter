...
class Product4Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Identical template to 1 & 2 & 3 but with distinct content
    return Scaffold(
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: SizeConfig.w(15)),
                      Text('4', style: AppTextStyles.interText.copyWith(fontWeight: FontWeight.w500, fontSize: SizeConfig.w(18))),
                      SizedBox(width: SizeConfig.w(15)),
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Text('\$26.99', style: AppTextStyles.robotoText.copyWith(fontWeight: FontWeight.w600, fontSize: SizeConfig.w(22), color: AppColors.white)),
              ),
            ),
            Positioned(
              top: SizeConfig.h(828),
